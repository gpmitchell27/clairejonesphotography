<section id="gallery">
	<div class="pnav">
		<ul>
			<li><a href="#" class="active">NATURE<span class="divider">|<span></a></li>
			<li><a href="#">WILD-LIFE<span class="divider">|<span></a></li>
			<li><a href="#">ACTION<span class="divider">|<span></a></li>
			<li><a href="#">PORTRAITS<span class="divider">|<span></a></li>
